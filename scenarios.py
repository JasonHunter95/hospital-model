"""
Scenario data and configuration presets for hospital SEIXHRD model simulations.
...
SCENARIO_BASELINE = {
    'name': 'Baseline', 'description': 'Default moderate outbreak in urban setting, no interventions',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['none'],
    'VE': VACCINE_EFFICACY_PRESETS['high'], 'Tmax': 200,
}

SCENARIO_LATE_ONSET_MILD_WAVE = {
    'name': 'Late-Onset Mild Wave', 'description': 'Mild outbreak with late seasonal peak',
    'beta_base': TRANSMISSION_PRESETS['very_mild']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['none'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'Tmax': 300,
}

SCENARIO_COVID_EARLY_2020 = {
    'name': 'COVID-19 Early 2020', 'description': 'Early pandemic wave, no vaccines, delayed lockdown',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_DELAYED_STRONG, 'vaccination': VACCINATION_STRATEGIES['none'],
    'VE': 0.0, 'Tmax': 200,
}

SCENARIO_COVID_DELTA = {
    'name': 'COVID-19 Delta Wave', 'description': 'High transmission Delta variant with partial vaccination',
    'beta_base': TRANSMISSION_PRESETS['high']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_MILD, 'waning_params': WANING_FAST,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['balanced_risk'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'Tmax': 365,
}

SCENARIO_COVID_OMICRON = {
    'name': 'COVID-19 Omicron Wave', 'description': 'Very high transmission but lower severity, high immunity',
    'beta_base': TRANSMISSION_PRESETS['severe']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_MODERATE, 'waning_params': WANING_VERY_FAST,
    'interventions': INTERVENTION_EARLY_MODERATE, 'vaccination': VACCINATION_STRATEGIES['herd_immunity_target'],
    'VE': VACCINE_EFFICACY_PRESETS['low'], 'Tmax': 200,
}

SCENARIO_SEASONAL_FLU = {
    'name': 'Seasonal Influenza', 'description': 'Typical flu season with moderate vaccination',
    'beta_base': TRANSMISSION_PRESETS['mild']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_STRONG, 'waning_params': WANING_MODERATE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['elderly_priority'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'Tmax': 365,
}

SCENARIO_ENDEMIC_EQUILIBRIUM = {
    'name': 'Endemic Equilibrium', 'description': 'Long-term endemic dynamics with waning immunity',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_MODERATE, 'waning_params': WANING_MODERATE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['balanced_risk'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'demographic_params': DEMOGRAPHIC_PARAMS_EQUILIBRIUM, 'Tmax': 730,
}

SCENARIO_HOSPITAL_STRESS_TEST = {
    'name': 'Hospital Stress Test', 'description': 'Severe outbreak overwhelming limited healthcare capacity',
    'beta_base': TRANSMISSION_PRESETS['high']['beta_base'], 'age_params': AGE_PARAMS_TEACHING,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_RURAL,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_DELAYED_MODERATE, 'vaccination': VACCINATION_STRATEGIES['none'],
    'VE': 0.0, 'Tmax': 200,
}

SCENARIO_OPTIMAL_RESPONSE = {
    'name': 'Optimal Response', 'description': 'Early intervention + high vaccination, well-resourced system',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_WELL_RESOURCED,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_SLOW,
    'interventions': INTERVENTION_EARLY_STRONG, 'vaccination': VACCINATION_STRATEGIES['herd_immunity_target'],
    'VE': VACCINE_EFFICACY_PRESETS['high'], 'Tmax': 300,
}

SCENARIO_RESOURCE_LIMITED = {
    'name': 'Resource-Limited Setting', 'description': 'Low-resource healthcare system with moderate outbreak',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_RESOURCE_LIMITED,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_DELAYED_MODERATE, 'vaccination': VACCINATION_STRATEGIES['uniform_low'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'Tmax': 200,
}

SCENARIO_SCHOOL_OUTBREAK = {
    'name': 'School Outbreak', 'description': 'Outbreak seeded in schools with school closure response',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_SCHOOL_CLOSURE, 'healthcare_system': HEALTHCARE_SYSTEM_SUBURBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_EARLY_MODERATE, 'vaccination': VACCINATION_STRATEGIES['young_priority'],
    'VE': VACCINE_EFFICACY_PRESETS['high'], 'initial_conditions': INITIAL_CONDITIONS_PRESETS['young_seed'], 'Tmax': 150,
}

SCENARIO_CARE_HOME_OUTBREAK = {
    'name': 'Care Home Outbreak', 'description': 'Outbreak starting in elderly care facility',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_ELDERLY_SHIELDING, 'healthcare_system': HEALTHCARE_SYSTEM_SUBURBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_EARLY_STRONG, 'vaccination': VACCINATION_STRATEGIES['elderly_only'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'initial_conditions': INITIAL_CONDITIONS_PRESETS['elderly_seed'], 'Tmax': 150,
}

SCENARIO_SURGE_CAPACITY = {
    'name': 'Surge Capacity Activation', 'description': 'Testing impact of surge capacity during severe wave',
    'beta_base': TRANSMISSION_PRESETS['high']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_SURGE_MAJOR,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_TIERED_ESCALATING, 'vaccination': VACCINATION_STRATEGIES['balanced_risk'],
    'VE': VACCINE_EFFICACY_PRESETS['moderate'], 'Tmax': 200,
}

SCENARIO_CYCLICAL_POLICY = {
    'name': 'Cyclical Intervention Policy', 'description': 'Testing on-off lockdown strategies',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_CYCLICAL, 'vaccination': VACCINATION_STRATEGIES['uniform_moderate'],
    'VE': VACCINE_EFFICACY_PRESETS['high'], 'Tmax': 250,
}

SCENARIO_NOVEL_PATHOGEN = {
    'name': 'Novel Pathogen Emergence', 'description': 'Unknown pathogen with high uncertainty',
    'beta_base': TRANSMISSION_PRESETS['high']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_EARLY_STRONG, 'vaccination': VACCINATION_STRATEGIES['none'],
    'vaccine_profile': None, 'VE': 0.0, 'Tmax': 200,
}

SCENARIO_VACCINE_ROLLOUT_PHASED = {
    'name': 'Phased Vaccine Rollout', 'description': 'Realistic vaccine campaign: elderly first',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_MILD, 'waning_params': WANING_MODERATE,
    'interventions': INTERVENTION_SUSTAINED_MODERATE, 'vaccination': {'coverage': [0.1, 0.2, 0.5], 'description': 'Phased rollout'},
    'vaccine_profile': 'mrna_original', 'vaccination_rate': [0.002, 0.003, 0.005], 'Tmax': 365,
}

SCENARIO_VARIANT_EMERGENCE = {
    'name': 'Variant Emergence Mid-Outbreak', 'description': 'New variant with immune escape',
    'beta_base': TRANSMISSION_PRESETS['severe']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_MODERATE, 'waning_params': WANING_VERY_FAST,
    'interventions': INTERVENTION_TIERED_ESCALATING, 'vaccination': VACCINATION_STRATEGIES['herd_immunity_target'],
    'vaccine_profile': 'mrna_omicron', 'initial_conditions': INITIAL_CONDITIONS_PRESETS['post_wave'], 'Tmax': 300,
}

SCENARIO_CAPACITY_COLLAPSE = {
    'name': 'Healthcare Capacity Collapse', 'description': 'Severe outbreak overwhelming minimal healthcare',
    'beta_base': TRANSMISSION_PRESETS['severe']['beta_base'], 'age_params': AGE_PARAMS_TEACHING,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_RESOURCE_LIMITED,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_DELAYED_MODERATE, 'vaccination': VACCINATION_STRATEGIES['none'],
    'vaccine_profile': None, 'VE': 0.0, 'Tmax': 200,
...
SCENARIO_ENDEMIC_VACCINATION = {
    'name': 'Endemic with Ongoing Vaccination', 'description': 'Long-term endemic with seasonal vaccination',
    'beta_base': TRANSMISSION_PRESETS['mild']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_STRONG, 'waning_params': WANING_MODERATE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['elderly_priority'],
    'vaccine_profile': 'influenza_typical', 'vaccination_rate': [0.001, 0.001, 0.002],
...
SCENARIO_SCHOOL_REOPENING = {
    'name': 'School Reopening Policy Test', 'description': 'Comparison of schools open vs closed',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_SUBURBAN,
    'seasonal_params': SEASONAL_PARAMS_MODERATE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['young_priority'],
    'vaccine_profile': 'mrna_original', 'initial_conditions': INITIAL_CONDITIONS_PRESETS['young_seed'], 'Tmax': 180,
}

SCENARIO_SENSITIVITY_TRANSMISSION = {
    'name': 'Transmission Sensitivity Base', 'description': 'Base scenario for beta sensitivity analysis',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['balanced_risk'],
    'vaccine_profile': 'mrna_original', 'Tmax': 200,
}

SCENARIO_SENSITIVITY_CAPACITY = {
    'name': 'Capacity Sensitivity Base', 'description': 'Base scenario for capacity sensitivity analysis',
    'beta_base': TRANSMISSION_PRESETS['high']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_NONE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['balanced_risk'],
...
SCENARIO_POPULATION_DYNAMICS = {
    'name': 'Open Population Dynamics', 'description': 'Long-term simulation with births and deaths',
    'beta_base': TRANSMISSION_PRESETS['moderate']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_MODERATE, 'waning_params': WANING_MODERATE,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['balanced_risk'],
    'vaccine_profile': 'mrna_original', 'demographic_params': DEMOGRAPHIC_PARAMS_EQUILIBRIUM, 'Tmax': 1095,
}

SCENARIO_NEONATAL_VACCINATION = {
    'name': 'Neonatal Vaccination Program', 'description': 'Long-term endemic with neonatal vaccination',
    'beta_base': TRANSMISSION_PRESETS['mild']['beta_base'], 'age_params': AGE_PARAMS_EMPIRICAL,
    'contact_matrix': CONTACT_MATRIX_DEFAULT, 'healthcare_system': HEALTHCARE_SYSTEM_URBAN,
    'seasonal_params': SEASONAL_PARAMS_NONE, 'waning_params': WANING_SLOW,
    'interventions': INTERVENTION_NONE, 'vaccination': VACCINATION_STRATEGIES['none'],
    'demographic_params': DEMOGRAPHIC_PARAMS_NEONATAL_VAX, 'Tmax': 1095,
}

SCENARIO_REGISTRY = {
    'baseline': SCENARIO_BASELINE, 'late_onset': SCENARIO_LATE_ONSET_MILD_WAVE,
    'covid_early_2020': SCENARIO_COVID_EARLY_2020, 'covid_delta': SCENARIO_COVID_DELTA,
    'covid_omicron': SCENARIO_COVID_OMICRON, 'seasonal_flu': SCENARIO_SEASONAL_FLU,
    'endemic': SCENARIO_ENDEMIC_EQUILIBRIUM, 'stress_test': SCENARIO_HOSPITAL_STRESS_TEST,
    'optimal_response': SCENARIO_OPTIMAL_RESPONSE, 'resource_limited': SCENARIO_RESOURCE_LIMITED,
    'school_outbreak': SCENARIO_SCHOOL_OUTBREAK, 'care_home_outbreak': SCENARIO_CARE_HOME_OUTBREAK,
    'surge_capacity': SCENARIO_SURGE_CAPACITY, 'cyclical_policy': SCENARIO_CYCLICAL_POLICY,
    'novel_pathogen': SCENARIO_NOVEL_PATHOGEN, 'vaccine_rollout_phased': SCENARIO_VACCINE_ROLLOUT_PHASED,
    'variant_emergence': SCENARIO_VARIANT_EMERGENCE, 'capacity_collapse': SCENARIO_CAPACITY_COLLAPSE,
    'endemic_vaccination': SCENARIO_ENDEMIC_VACCINATION, 'school_reopening': SCENARIO_SCHOOL_REOPENING,
    'sensitivity_transmission': SCENARIO_SENSITIVITY_TRANSMISSION, 'sensitivity_capacity': SCENARIO_SENSITIVITY_CAPACITY,
    'population_dynamics': SCENARIO_POPULATION_DYNAMICS, 'neonatal_vaccination': SCENARIO_NEONATAL_VACCINATION,
}
